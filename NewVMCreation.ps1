...
.RELEASENOTES
Developed internally to be used by Peeps
...
If ($VmSize -eq 'Regular') {Create-Regular} Elseif ($VmSize -eq 'Fast'){Create-Fast} Elseif ($VmSize -eq 'Slow'){Create-Slow}
